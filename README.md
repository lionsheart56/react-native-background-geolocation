# @lionsheart56/react-native-background-geolocation
...
```
yarn add @lionsheart56/react-native-background-geolocation
```
...
```
node ./node_modules/@lionsheart56/react-native-background-geolocation/scripts/postlink.js
```
...
```gradle
...
include ':@lionsheart56_react-native-background-geolocation-common'
project(':@lionsheart56_react-native-background-geolocation-common').projectDir = new File(rootProject.projectDir, '../node_modules/@lionsheart56/react-native-background-geolocation/android/common')
include ':@lionsheart56_react-native-background-geolocation'
project(':@lionsheart56_react-native-background-geolocation').projectDir = new File(rootProject.projectDir, '../node_modules/@lionsheart56/react-native-background-geolocation/android/lib')
...
```
...
dependencies {
    ...
    compile project(':@lionsheart56_react-native-background-geolocation')
    ...
}
```
...
2. Add `./node_modules/@lionsheart56/react-native-background-geolocation/ios/RCTBackgroundGeolocation.xcodeproj`
...
import BackgroundGeolocation from '@lionsheart56/react-native-background-geolocation';
